      ...
      <div className="contact-container">
        <div className="contact-options">
          ...
          <div className="contact-card">
            ...
            <a 
              href="https://wa.me/5491141442409" 
              target="_blank" 
          ...
          <div className="contact-card">
            ...
            <div style={{ display: 'flex', gap: '10px', justifyContent: 'center' }}>
              <a href="https://www.tiktok.com/@liazapatos" target="_blank" rel="noopener noreferrer" className="contact-link">TikTok</a>
              <a href="https://www.facebook.com/zapatos.lia.2020/" target="_blank" rel="noopener noreferrer" className="contact-link">Facebook</a>
            </div>
          </div>
          ...
          <div className="contact-card">
            ...
            <a href="mailto:liazapatos2001@gmail.com" className="contact-link" style={{ marginBottom: '10px', display: 'block' }}>liazapatos2001@gmail.com</a>
            <button 
              className="contact-btn"
